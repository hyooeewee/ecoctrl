export const enUS = {
  ...
  settings: {
    ...
    environmentPreset: "Environment Scene",
    environmentPresetDesc:
      "Choose the background environment and lighting style for the 3D building",
    envPresetNames: {
      studio: "Studio",
      cyclorama: "Hard Light",
      studioSoft: "Soft Studio",
      constructionYard: "Construction Yard",
      betweenBridges: "Urban Bridges",
      sanGiuseppeBridge: "Sunset Bridge",
      environmentSpecular: "Neutral Specular",
      ulmerMuenster: "Outdoor Plaza",
    },

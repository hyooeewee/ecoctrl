...
export const ALERTS: Alert[] = [
  { id: '1', device: '中央空调 A1', level: 'high', message: '能耗异常波动 (超出阈值 20%)', time: '10:15:22', status: 'pending' },
  { id: '2', device: '配电柜 B3', level: 'medium', message: '电压不稳定告警', time: '09:45:10', status: 'pending' },
  { id: '3', device: '水泵 C1', level: 'low', message: '例行维保提醒', time: '08:00:00', status: 'resolved' },
  { id: '4', device: '电梯 #4', level: 'high', message: '传感器故障', time: '11:20:05', status: 'pending' },
  { id: '5', device: '照明控制系统', level: 'medium', message: '通讯中断', time: '10:55:30', status: 'pending' },
];
...
export const REPORT_PLANS: ReportPlan[] = [
  { id: '1', name: '周度能耗报表', receiver: 'admin@energy.com', frequency: '每周一', status: true },
  { id: '2', name: '碳排放统计报表', receiver: 'sustainability@energy.com', frequency: '每月 1 日', status: true },
  { id: '3', name: '设备故障率分析', receiver: 'maintenance@energy.com', frequency: '每月末', status: false },
];

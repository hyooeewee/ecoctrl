    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm">管理平台用户列表、角色分配及系统权限控制。</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <SheetContent className="sm:max-w-md">
            ...
            <SheetFooter>
              <Button type="submit" className="w-full" onClick={() => console.log('Creating new account...')}>确认创建</Button>
            </SheetFooter>
          </SheetContent>
        </Sheet>
        </div>
      ...
      <Card className="border-none shadow-sm overflow-hidden">
        <CardHeader className="bg-white px-6 pb-4 border-b border-gray-50">
          <div className="flex items-center gap-4">
            ...
            <Button variant="outline" className="h-10">筛选</Button>
          </div>
        </CardHeader>

    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="models" className="w-full">
        <TabsList className="mb-6 bg-gray-100/80 p-1">
          <TabsTrigger value="models" className="px-6 flex gap-2 items-center data-selected:bg-white data-selected:shadow-sm">
            <Box size={16} />
            模型资源
          </TabsTrigger>
          <TabsTrigger value="objects" className="px-6 flex gap-2 items-center data-selected:bg-white data-selected:shadow-sm text-gray-500">
            <Layers size={16} />
            业务对象
          </TabsTrigger>
        </TabsList>
          ...
          <Card className="border-none shadow-sm">
            ...
            <CardContent className="px-6 pb-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <Card key={i} className="group cursor-pointer hover:border-blue-200 transition-colors relative">

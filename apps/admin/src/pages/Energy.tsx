  ...
  return (
    <div className="flex h-full flex-col overflow-hidden p-6">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex h-full flex-col">
        <TabsContent value="overview" className="mt-0 flex h-full flex-col overflow-hidden">
        ...
        <TabsContent value="details" className="mt-0 flex h-full flex-col overflow-hidden">
          <Card className="flex h-full flex-col overflow-hidden border shadow-sm">
            ...
            <CardContent className="flex-1 overflow-auto mx-6 my-6 flex items-center justify-center rounded-lg">
              <p className="text-muted-foreground text-sm">详细数据内容待补充</p>
            </CardContent>
          </Card>
        </TabsContent>

        <TabsContent value="stats" className="mt-0 flex h-full flex-col overflow-hidden">
          <Card className="flex h-full flex-col overflow-hidden border shadow-sm">
            <CardHeader className="shrink-0 border-b px-6">
        ...
        <TabsContent value="config" className="mt-0 flex h-full flex-col overflow-hidden">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 flex-1 min-h-0">
            {/* Tree panel */}
            <Card className="flex flex-col overflow-hidden border shadow-sm lg:col-span-1">
            ...
            {/* Detail panel */}
            <Card className="flex flex-col overflow-hidden border shadow-sm lg:col-span-2">
              <CardHeader className="shrink-0 border-b px-6">

...
function AutocompleteEmpty({
  ...
  return (
    <AutocompletePrimitive.Empty
      className={cn("py-2 pl-2 empty:p-0 text-sm text-muted-foreground", className)}
      {...props}
    />
  );
}
...
function AutocompleteList({
  ...
  return (
    <AutocompletePrimitive.List
      className={cn(
        "py-2 overflow-y-auto scroll-py-2 overscroll-contain max-h-[min(23rem,var(--available-height))] data-empty:p-0",
        className,
      )}
      {...props}
    />
